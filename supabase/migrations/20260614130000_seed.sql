...
values
  ...
  (
    ...
    'L1',
    8, 9, 12,
    'Vi bygger videre på grunnlaget fra L0 og begynner å lære arabiske bokstaver og enkle bønner.',
    'Building on the foundation from L0, we start learning Arabic letters and simple prayers.',
